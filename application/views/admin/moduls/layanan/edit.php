            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" name="foto_lMateri" id="edit_input_foto5">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="judul_materi" placeholder="Nama Layanan" value="<?= $data->judul_materi ?>" required>
                    ...
                    <!-- <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="judul_materi_en" placeholder="Nama Layanan" value="<?= $data->judul_materi_en ?>" required>
