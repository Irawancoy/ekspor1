<body>
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="<?php echo site_url('importir')?>">Importir</a></li>
  ...
  <main id="main">
    ...
    <section class="services">
      <div class="container">
        <div class="row">
				<?php foreach ($buyer->result() as $p) : ?>

          <div class="col-md-6 col-lg-4 d-flex align-items-stretch" data-aos="fade-up">
            <div class="icon-box icon-box-pink">
							<h4 class="title"><a href=""><?php echo $p->produk_buyers; ?></a></h4>
							<ul>
								<li><strong>Negara :</strong> <?php echo $p->negara_buyers; ?></li>
								<li><strong>Perusahaan :</strong> <?php echo $p->nama_perusahaan_buyers; ?></li>
								<li><strong>Email      :</strong> <?php echo $p->email_buyers; ?></li>
							</ul>
						</div>
          </div>
				<?php endforeach; ?>
